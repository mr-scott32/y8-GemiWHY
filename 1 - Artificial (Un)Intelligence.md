...
* Read and compare information from multiple websites.
* Judge which sources are credible and which may be misleading.
* Summarise information in their own words.

These steps take more effort, but they also strengthen **information literacy**—the ability to tell the difference between fact and opinion, and to use evidence to support ideas.
...
* Using **Google**, the student must explore history websites, academic sources, and encyclopaedias. They will learn to check which sources are trustworthy, compare different perspectives, and piece together their own explanation. This process not only builds knowledge of history but also strengthens critical thinking.
* Using an **AI tool**, the student could type the question and instantly receive a neat summary. While quick, this bypasses the research process and may provide oversimplified or inaccurate information.
